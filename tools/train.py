...
class StandardTrainer:
    ...
    def initialize_system(self):
        ...
        self.logger.info('=== Initiating System Setup ===')
    ...
    def setup_data_loaders(self):
        self.training_dataset, self.training_data_loader, self.training_sampler = build_dataloader(
    ...
    def run_training(self):
        self.logger.info(f'*** Starting Training Cycle: {self.cfg.EXP_GROUP_PATH}/{self.cfg.TAG}({self.args.extra_tag}) ***')
        train_model(
            self.model,
        ...
        self.logger.info(f'*** Training Cycle Completed: {self.cfg.EXP_GROUP_PATH}/{self.cfg.TAG}({self.args.extra_tag}) ***\n\n\n')
...
if __name__ == '__main__':
    ...
    trainer = StandardTrainer(arguments, configuration)
